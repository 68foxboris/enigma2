...
class CIHelper:
	...
	def ciRecordEvent(self, service, event):
		if event in (iRecordableService.evEnd, iRecordableService.evStart, None):
			...
			if NavigationInstance.instance.getAnyRecordingsCount() and hasattr(NavigationInstance.instance, "RecordTimer") and hasattr(NavigationInstance.instance.RecordTimer, "timer_list"):
