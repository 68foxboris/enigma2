...
config.plugins.configurationbackup.backupdirs = ConfigLocations(default=[eEnv.resolve('${sysconfdir}/enigma2/'), '/etc/network/interfaces', '/etc/wpa_supplicant.ath0.conf', "/etc/resolv.conf", '/etc/enigma2/nameserversdns.conf', '/etc/default_gw', '/etc/hostname', '/home/root/.config/content_shell/', '/etc/wg_token.key'])
