...
from Components.MultiContent import MultiContentEntryText, MultiContentEntryRectangle, MultiContentEntryPixmapAlphaBlend
...
class VirtualKeyBoard(Screen):
	...
	def __init__(self, session, title=_("Virtual KeyBoard Text:"), text="", maxSize=False, visible_width=False, type=Input.TEXT, currPos=None, allMarked=False, style=VKB_ENTER_ICON, windowTitle=None):
		...
		self.bg = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_bg.png"))  # Legacy support only!
		self.bg_l = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_bg_l.png"))
		self.bg_m = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_bg_m.png"))
		self.bg_r = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_bg_r.png"))
		self.sel_l = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_sel_l.png"))
		self.sel_m = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_sel_m.png"))
		self.sel_r = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_sel_r.png"))
		key_red_l = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_red_l.png"))
		key_red_m = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_red_m.png"))
		key_red_r = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_red_r.png"))
		key_green_l = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_green_l.png"))
		key_green_m = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_green_m.png"))
		key_green_r = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_green_r.png"))
		key_yellow_l = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_yellow_l.png"))
		key_yellow_m = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_yellow_m.png"))
		key_yellow_r = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_yellow_r.png"))
		key_blue_l = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_blue_l.png"))
		key_blue_m = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_blue_m.png"))
		key_blue_r = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_blue_r.png"))
		key_backspace = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_backspace.png"))
		key_clear = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_clear.png"))
		key_delete = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_delete.png"))
		key_enter = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_enter.png"))
		key_exit = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_exit.png"))
		key_first = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_first.png"))
		key_last = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_last.png"))
		key_left = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_left.png"))
		key_locale = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_locale.png"))
		key_right = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_right.png"))
		key_shift = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_shift.png"))
		key_shift0 = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_shift0.png"))
		key_shift1 = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_shift1.png"))
		key_shift2 = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_shift2.png"))
		key_shift3 = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_shift3.png"))
		key_space = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_space.png"))
		key_space_alt = loadKeyPixmap(path=resolveFilename(SCOPE_GUISKIN, "buttons/vkey_space_alt.png"))
